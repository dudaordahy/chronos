...
export function AboutPomodoro() {
  return (
    <MainTemplate>
      <Container>
        <GenericHTML>
          <Heading>A Técnica Pomodoro ✍️</Heading>
          ...
          <p>
            ...
            <a href="/settings">página de configurações</a> e ajustar
          ...
          <p>
            ...
            no <a href="/history">histórico</a>, com status de completas
            ou interrompidas. Assim, você consegue acompanhar sua evolução
            ao longo do tempo.
          </p>
